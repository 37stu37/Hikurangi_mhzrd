...
os.chdir(r'F:\Dropbox\Work\Repository\PhD\revisions\OQ\run\site_model')


model = 'FJ'
csv_site_info_directory = '.'
out_directory = '.'
#csv_site_info = 'test.csv'
csv_site_info = 'FJ_vs30_nodes.csv'
out_filename = model + '_New_site-model.xml'
